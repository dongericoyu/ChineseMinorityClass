...
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
 & \multicolumn{8}{c}{\textit{Mean and Percentage of Respondents Who Are}} \\ 
\cline{2-5} 
\\[-1.8ex] & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{male} & \multicolumn{1}{c}{education level} & \multicolumn{1}{c}{income} & \multicolumn{1}{c}{CCP member} & \multicolumn{1}{c}{rural hukou}\ & \multicolumn{1}{c}{urban hukou} & \multicolumn{1}{c}{local hukou}\ 

\\[-1.8ex] & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{percentage} & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{mean} & \multicolumn{1}{c}{percentage} & \multicolumn{1}{c}{percentage}\ & \multicolumn{1}{c}{percentage} & \multicolumn{1}{c}{percentage}\
\hline \\[-1.8ex] 
...
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
 & \multicolumn{4}{c}{\textit{Dependent variable:Retrospetive and Prospective Mobility}} \\ 
\cline{2-5} 
\\[-1.8ex] & \multicolumn{1}{c}{Model 9} & \multicolumn{1}{c}{Model 10 } & \multicolumn{1}{c}{Model 11} & \multicolumn{1}{c}{Model 12} \\ 
\\[-1.8ex] & \multicolumn{1}{c}{(Retro)} & \multicolumn{1}{c}{(Prosp)} & \multicolumn{1}{c}{(Retro)} & \multicolumn{1}{c}{(Prosp)}\\ 
\hline \\[-1.8ex] 
 ...
 \hline \\[-1.8ex] 
Observations & \multicolumn{1}{c}{11,735} & \multicolumn{1}{c}{11,735} & \multicolumn{1}{c}{11,985} & \multicolumn{1}{c}{11,985} \\ 
Akaike Inf. Crit. & \multicolumn{1}{c}{37,704.510} & \multicolumn{1}{c}{37,779.290} & \multicolumn{1}{c}{38,594.490} & \multicolumn{1}{c}{38,473.320} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
